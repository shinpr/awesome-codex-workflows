...
- [dazuiba/handoff](https://github.com/dazuiba/handoff) - Cross-agent task dispatcher: send work to DeepSeek V4 or other agents from inside a Codex session, without losing context. Runs in background via `handoff run`; result returns to the caller automatically.
