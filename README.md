...
- [mturac/everything-openai-codex](https://github.com/mturac/everything-openai-codex) - Open-source Codex workflow system with agents, skills, commands, hooks, memory patterns, install profiles, quality gates, and cross-harness adapters for repeatable engineering sessions.
